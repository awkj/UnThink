...
const ItemPositionSchema = z.discriminatedUnion("type", [
  z.object({
...
// ===== Add Actions =====
const AddTaskInHeadingSchema = z.object({
...
const AddTaskActionSchema = z.object({
...
const AddHeadingActionSchema = z.object({
...
const UpdateHeadingActionSchema = z.object({
...
const UpdateAreaActionSchema = z.object({
...
const BatchEditActionSchema = z.discriminatedUnion("type", [
  AddTaskActionSchema,
...
// Group schema
const BatchEditGroupSchema = z.object({
