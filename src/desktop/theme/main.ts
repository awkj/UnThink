...
export const desktopStyles = {
  ...
  SidebarBottomBar: /*tw*/ "h-12 flex flex-shrink-0 items-center gap-1 border-t border-line-light px-2",
  SidebarBottomCreateButton:
    /*tw*/ "h-8 min-w-0 flex flex-1 items-center gap-2 rounded-md px-2 text-sm text-t2 transition-colors hover:bg-bg3 hover:text-t1",
  SidebarBottomCreateIcon: /*tw*/ "size-4 flex-shrink-0",
  SidebarBottomCreateLabel: /*tw*/ "truncate font-medium",
  SidebarBottomActions: /*tw*/ "ml-auto flex items-center gap-0.5",
  SidebarBottomIconButton:
    /*tw*/ "flex size-8 items-center justify-center rounded-md text-t3 transition-colors hover:bg-bg3 hover:text-t1",
  SidebarBottomIcon: /*tw*/ "size-4",

  SidebarMenuItemContainer: /*tw*/ "flex flex-col gap-0.5 px-2",
  SidebarPrimaryMenuSpacing: /*tw*/ "pt-3.5",
  SidebarInboxMenuItem: /*tw*/ "mb-2",
  SidebarMenuItem:
    /*tw*/ "h-8 px-2.5 flex rounded-lg text-[15px] leading-5 items-center gap-2.5 group transition-colors",
